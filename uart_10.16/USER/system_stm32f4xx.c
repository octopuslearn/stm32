...
void SystemInit(void)
{
  ...
  /* Set HSION bit */
  RCC->CR |= (uint32_t)0x00000001;	////1£ºHSI Õñµ´Æ÷´ò¿ª

  /* Reset CFGR register */
  RCC->CFGR = 0x00000000;	////µÚ0Î»ºÍµÚ1Î»ÎªÁã£¬Ñ¡ÔñHSEÕñµ´Æ÷×÷ÎªÏµÍ³Ê±ÖÓ

  /* Reset HSEON, CSSON and PLLON bits */
  RCC->CR &= (uint32_t)0xFEF6FFFF;

  /* Reset PLLCFGR register */
  RCC->PLLCFGR = 0x24003010;	////ÅäÖÃPLL·ÖÆµÏµÊý

  /* Reset HSEBYP bit */
  RCC->CR &= (uint32_t)0xFFFBFFFF;	////´ò¿ªÁËHSE
...
/******************************************************************************/
  ...
  /* Enable HSE */
  RCC->CR |= ((uint32_t)RCC_CR_HSEON);	////½«CR¼Ä´æÆ÷µÚ16Î»ÖÃÒ»£¬¼´HSEÕñµ´Æ÷´ò¿ª
  /*µÈ´ýHSEÎÈ¶¨*/
